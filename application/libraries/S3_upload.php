...
class S3_upload {
	...
	function upload_file($file_path)
	{
        ...
        //echo($saved);
		if ($saved) {
			//echo('https://'.$this->bucket_name.'.s3.ap-south-1.amazonaws.com/'.$this->folder_name.$s3_file);
			return 'https://'.$this->bucket_name.'.s3.ap-south-1.amazonaws.com/'.$this->folder_name.$s3_file;
