...
$config['access_key'] = 'AKIAXWO7L7V2L5L3YY5Q';
...
$config['secret_key'] = '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';
...
$config['bucket_name'] = 'stich-bucket';
...
//$config['folder_name'] = 'dev/';
$config['folder_name'] = 'gallery/';
...
$config['s3_url'] = 'https://stich-bucket.s3.ap-south-1.amazonaws.com';
